...
class PlaylistModelTestCase(TestCase):
    ...
    def create_videos(self):
        ...
        video_b = Video.objects.create(title="My Title",video_id="2")
        self.video_b = video_b
        video_c = Video.objects.create(title="My Title",video_id="3")
    ...
    def setUp(self):
        ...
        # obj_b.videos.set([self.video_a,self.video_b,self.video_c]) #We cannot direct assign in manyTomanyField, we have to use .set() method
